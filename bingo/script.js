...
function computeProblemFontSize() {
  ...
  // width, and word-break wraps it onto a second line. (#problem-text is
  // weight 800; this probe was previously hard-coded to 700.)
...
function updateFullscreenBtn() {
  ...
  // available to the caller problem — re-fit it. rAF lets the layout settle;
  // computeProblemFontSize is a no-op outside the caller view.
  requestAnimationFrame(computeProblemFontSize);
  if (!btn) return;
